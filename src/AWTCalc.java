...
class AWTCalc extends WindowAdapter implements ActionListener {
    Frame f;
    Label l1;
    ...
    AWTCalc() {
        ...
        f.add(badd); f.add(bsub); f.add(bmult); f.add(bdiv); f.add(bmod); f.add(bcalc) ; f.add(bclr);
        f.add(bpts); f.add(bneg); f.add(bback);
